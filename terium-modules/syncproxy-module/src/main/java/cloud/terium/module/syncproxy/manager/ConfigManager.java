...
public class ConfigManager {
    ...
    private void initFile() {
        ...
        if (!file.exists()) {
            ...
            json.addProperty("motd.line2", "<gray>› <white>Terium by <#41dbfa>jxnnikdev <white>and <#69e2fa>contributors <red>❤");
